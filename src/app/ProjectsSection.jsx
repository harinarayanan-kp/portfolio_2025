...
const ProjectsSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="project-cards-row-container">
        {/* Left scroll button */}
        <button
          className="project-scroll-btn left"
          aria-label="Scroll left"
          onClick={() => {
            const container = document.getElementById("project-cards-row");
            if (container)
        ...
        <div id="project-cards-row" className="project-cards-row">
        ...
        {/* Right scroll button */}
        <button
          className="project-scroll-btn right"
